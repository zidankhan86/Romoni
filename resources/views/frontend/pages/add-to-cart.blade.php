...
@section('content')
    ...
    <div class="container py-5">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <form action="{{ route('cart.update', $item->id) }}" method="POST">
                                            @csrf
                                            @method('PATCH')
                                            <select class="form-select form-select-sm w-auto mx-auto" name="quantity"
                                    ...
                                    <td class="text-center fw-semibold">BDT
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h5 class="mb-0">Subtotal: <span class="fw-bold text-primary">BDT {{ number_format($totalPrice, 2) }}</span>
            </h5>
        </div>
