...
<div class="container mt-5 mb-5">
    ...
    : 'https://bootdey.com/img/Content/avatar/avatar3.png' }}" class="rounded-circle mb-3 shadow-sm" width="100"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="list-unstyled mb-0">
                                            ...
                                            <li>{{ $item->product_name }} <small class="text-muted">(x{{ $item->quantity
                                                    }})</small></li>
                                            @endforeach
                                        </ul>
                                    </td>
