    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                ...
                <p class="mb-0"><i class="bi bi-telephone-fill me-2"></i> Call: {{$settings->phone ?? ''}}</p>
            </div>
            ...
            <div class="col-md-4 mb-4">
                ...
                <div class="d-flex gap-3 mt-4">
                    <a href="{{$settings->facebook_link ?? '#'}}" target="_blank" class="social-icon"><i class="bi bi-facebook"></i></a>
                    <a href="{{$settings->instagram_link ?? '#'}}" target="_blank" class="social-icon"><i class="bi bi-instagram"></i></a>
                    <a href="{{$settings->youtube_link ?? '#'}}" target="_blank" class="social-icon"><i class="bi bi-youtube"></i></a>
                </div>
            </div>
        </div>
