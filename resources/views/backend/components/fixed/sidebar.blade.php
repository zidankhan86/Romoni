...
<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
   ...
   <li class="nav-item ">
            <a class="nav-link" href="{{ route('staff.index') }}"  data-bs-auto-close="false" role="button" aria-expanded="false" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item ">
            <a class="nav-link" href="{{ route('contact.showList') }}"  data-bs-auto-close="false" role="button" aria-expanded="false" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item ">
            <a class="nav-link" href="{{ route('settings.edit') }}"  data-bs-auto-close="false" role="button" aria-expanded="false" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
